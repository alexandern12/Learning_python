...
def start_up_board():
    ...
    column1 = []; column2 = []; column3 = []; column4 = []; column5 = []; column6 = []; column7 = []; drawing_column = []
...
def draw_board(win, column1, column2, column3, column4, column5, column6, column7, drawing_column, discard_column, card_width, card_height, 
    ...
    def draw_cards(column):
        ...
        for card_type, card_number in column:
            ...
            if (card_type, card_number) in visible_cards:
                ...
                colour = (250, 250, 250)
                # card background
                pygame.draw.rect(win, colour, (30 + cc * (card_width + 15), row * count * 40 + card_height + 20, card_width, card_height))
                # outline:
                pygame.draw.rect(win, (0,0,0), (30 + cc * (card_width + 15), row * count * 40 + row * card_height + 20, card_width, card_height), 1)
                # symbol and number
                win.blit(label, (40 + cc * (card_width + 15), row * count * 40 + card_height + 20))
                
            else:
                # draw blue cards
                pygame.draw.rect(win, (0,0,(100+(count*20))), (30 + cc * (card_width + 15), row * count * 40 + row * card_height + 20, card_width, card_height))
                pygame.draw.rect(win, (0,0,0), (30 + cc * (card_width + 15), row * count * 40 + row * card_height + 20, card_width, card_height), 1)
            
            def draw_selection():
                pygame.draw.rect(win, (200,200,0), (30 + cc * (card_width + 15), row * count * 40 + row * card_height + 20, card_width, card_height), 5)
...
def main():
    ...
    visible_cards = []; final_column1 = []; final_column2 = []; final_column3 = []; final_column4 = []; discard_column = []
    width = 1200
    height = 800
    card_width = 150
    card_height = 200
    ...
    while flag:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                visible_cards = visible_card_list(visible_cards, column1, column2, column3, column4, column5, column6, column7, discard_column)
                # draw the playing field
                draw_board(win, column1, column2, column3, column4, column5, column6, column7, drawing_column, discard_column, card_width, card_height,
                                visible_cards, final_column1, final_column2, final_column3, final_column4, mpos_x, mpos_y)
